        ...
        <div className="grid md:grid-cols-2 items-center gap-0">
          ...
          <div className="p-8 md:p-12 lg:p-16">
           ...
           <button
            ...
            className="w-full py-3 px-4 flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 rounded-xl text-sm font-medium text-gray-700 transition-colors"
>
